...
class AuthControllerVerifyTest {
    ...
    private final AuthController controller = new AuthController(mock(TenancyApi.class), mock(com.dmc.archiving.user.api.UserApi.class), signer, mock(RegistrationService.class));
