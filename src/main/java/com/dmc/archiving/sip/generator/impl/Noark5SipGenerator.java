...
public class Noark5SipGenerator extends AbstractSipGenerator {
    ...
    @Override
    protected PackagePayload buildPayload(SipSnapshot s) {
    ...
    private static Element rebuildElement(SipSnapshot s) {
        ...
        // Fields: SipSnapshot stores name→value strings; we don't reconstruct
