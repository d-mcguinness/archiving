...
@Component
public class EarkDipGenerator extends AbstractDipGenerator {

    public EarkDipGenerator(CloudStorageService cloudStorageService) {
    ...
    public Map<String, Object> buildPackage(Dip dip) {
        ...
        if (dip.getSourceAipId() != null) {
            pkg.put("sourceAipId", dip.getSourceAipId());
        }
