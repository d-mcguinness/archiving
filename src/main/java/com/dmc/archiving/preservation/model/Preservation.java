...
@Entity
@Table(name = "preservations", indexes = {
...
public class Preservation {
    ...
    @JoinTable(
        name = "preservation_users",
        joinColumns = @JoinColumn(name = "preservation_id"),
    ...
    public boolean equals(Object o) {
        ...
        Preservation aip = (Preservation) o;
