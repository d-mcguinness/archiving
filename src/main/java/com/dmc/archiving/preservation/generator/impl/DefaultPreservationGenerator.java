...
@Component
public class DefaultPreservationGenerator extends AbstractPreservationGenerator {

    public DefaultPreservationGenerator(CloudStorageService cloudStorageService) {
