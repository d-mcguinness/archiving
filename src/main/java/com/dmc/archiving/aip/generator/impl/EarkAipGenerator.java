...
@Component
public class EarkAipGenerator extends AbstractAipGenerator {

    public EarkAipGenerator(CloudStorageService cloudStorageService) {
    ...
    public Map<String, Object> buildPackage(Aip aip) {
        ...
        if (aip.getSourceSipId() != null) {
            pkg.put("sourceSipId", aip.getSourceSipId());
        }
