<script lang="ts">
  ...
  $: if (browser && $auth.isLoggedIn && $auth.role === 'TENANT' && $auth.tenantId) {
    goto(`/tenants/${$auth.tenantId}/aips`);
  }
</script>

<svelte:head>
  <title>AIPs - Arcana</title>
</svelte:head>
...
{#if !$auth.isLoggedIn}
  <div class="public-page">
    <section class="hero">
      ...
      <h1>Archival Information Packages</h1>
      <p class="hero-subtitle">
        AIPs represent the long-term storage format in the OAIS model. They contain preserved content
    ...
    <section class="features-section">
      <h2 class="section-title">AIP Capabilities</h2>
    ...
    <section class="cta-section">
      ...
      <p>Sign in to create and manage your AIPs.</p>
