<script lang="ts">
  ...
  onMount(async () => {
    ...
    // Only ADMIN can access the archives list page
...
<svelte:head>
  <title>Archives - Admin - Archiving System</title>
</svelte:head>
...
<div class="archives-page">
  {#if !hasAccess && !loading}
    ...
    <div class="access-denied">
      ...
      <h1>Access Denied</h1>
      <p>You don't have permission to access the admin archives list.</p>
