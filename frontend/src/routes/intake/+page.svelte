<script lang="ts">
  ...
  $: if (browser && $auth.isLoggedIn && $auth.role === 'TENANT' && $auth.tenantId) {
    goto(`/tenants/${$auth.tenantId}/intakes`);
  }
</script>

<svelte:head>
  <title>Intakes - Arcana</title>
</svelte:head>
  ...
  <div class="public-page">
    <section class="hero">
      ...
      <p class="hero-subtitle">
        Intakes are the entry point to the OAIS preservation workflow. They contain the digital content
    ...
    <section class="features-section">
      <h2 class="section-title">Intake Capabilities</h2>
      <div class="features-grid">
        <div class="feature-card">
          <span class="feature-icon">📦</span>
          <h3>Standard-Compliant</h3>
          <p>Build Intakes using 10 archival standards including NOARK5, OAIS, PREMIS, Dublin Core, and E-ARK.</p>
        </div>
        <div class="feature-card">
          <span class="feature-icon">🌳</span>
        ...
        <div class="feature-card">
          ...
          <p>Attach and associate documents with Intakes for complete submission packages.</p>
        </div>
        <div class="feature-card">
          <span class="feature-icon">✅</span>
          <h3>Validation</h3>
    ...
    <section class="cta-section">
      ...
      <p>Sign in to create and manage your Intakes.</p>
...
<style>
  ...
  .hero-badge {
    ...
    background: var(--arc-chip-pink-bg); color: var(--arc-chip-pink-ink);
