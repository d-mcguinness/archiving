...
<div class="dip-container">
  ...
  <div class="dip-header"><div class="dip-header-top"><div><h1>Create Release package</h1>{#if archive}<p class="subtitle">Archive: {archive.title} ({archive.standard})</p>{/if}</div>
