...
<style>
  .sip-container { max-width: 960px; margin: 2rem auto; background: var(--arc-card); padding: 2.5rem; border-radius: 1rem; box-shadow: var(--arc-shadow-card); border: 1px solid var(--arc-line); }
  ...
  .btn-defaults { padding: 0.625rem 1.25rem; background: var(--arc-card); color: var(--arc-ink); font-size: 0.85rem; white-space: nowrap; flex-shrink: 0; border: 1.5px solid var(--arc-line-strong); border-radius: 0.65rem; cursor: pointer; font-weight: 700; box-shadow: none; }
  ...
  .btn-defaults:disabled { background: var(--arc-card-2); border-color: var(--arc-line-strong); color: var(--arc-faint); cursor: not-allowed; }
  .standard-info { padding: 1rem; background: var(--arc-alert-indigo-bg); border: 1px solid var(--arc-alert-indigo-border); border-radius: 0.6rem; border-left: 4px solid var(--arc-indigo); }
  ...
  .form-group label { display: flex; align-items: center; gap: 0.375rem; margin-bottom: 0.5rem; color: var(--arc-ink); font-weight: 500; font-size: 0.85rem; }
