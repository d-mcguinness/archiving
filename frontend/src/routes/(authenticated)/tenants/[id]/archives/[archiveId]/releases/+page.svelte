          ...
          <tbody>
            {#each filteredReleases as dip (dip.id)}
              <tr>
                ...
                <td><span class="badge standard">{dip.standard}</span></td>
                ...
                <td class="actions-cell"><a href="/release/edit/{dip.id}" class="btn-action btn-edit">✏️ Edit</a></td>
              </tr>
            {/each}
          </tbody>
        </table>
...
<style>
  ...
  .spinner { border: 4px solid #f3f4f6; border-top: 4px solid #f97316; border-radius: 50%; width: 40px; height: 40px; animation: spin 1s linear infinite; }
  ...
  .btn-create { padding: 0.65rem 1.25rem; background: #f97316; color: white; border-radius: 0.5rem; text-decoration: none; font-weight: 600; font-size: 0.875rem; transition: background 0.2s; white-space: nowrap; }
  ...
  .data-table thead { background: #fff7ed; border-bottom: 2px solid #fed7aa; }
  .data-table th { padding: 1rem; text-align: left; font-weight: 600; color: #9a3412; font-size: 0.875rem; text-transform: uppercase; letter-spacing: 0.05em; }
  ...
  .standard { background: #fff7ed; color: #9a3412; }
  .status-draft { background: #fef3c7; color: #92400e; } .status-prepared { background: #dbeafe; color: #1e40af; } .status-disseminated { background: #dcfce7; color: #166534; } .status-expired { background: #f3f4f6; color: #4b5563; } .status-rejected { background: #fee2e2; color: #991b1b; }
