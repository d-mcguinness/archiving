...
<style>
  ...
  .table-container { background: var(--arc-card); border-radius: 1rem; overflow-x: auto; box-shadow: var(--arc-shadow-card); border: 1px solid var(--arc-line); border-top: 3px solid #f97316; }
  ...
  .standard { background: var(--arc-chip-orange-bg); color: var(--arc-chip-orange-ink); }
