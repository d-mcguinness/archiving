...
<div class="tenant-dips-page">
  ...
  {:else}
    ...
    <div class="page-header">
      ...
      <a href="/tenants/{data.tenantId}/releases/create" class="btn-create">+ Create Release</a>
    </div>
    ...
    {:else if dips.length === 0}
      <div class="empty-state">
        ...
        <a href="/tenants/{data.tenantId}/releases/create" class="btn-primary-link">Create Release</a>
      </div>
    {:else}
            ...
            {#each dips as dip (dip.id)}
              <tr>
                ...
                <td class="actions-cell">
                  <a href="/release/edit/{dip.id}" class="btn-action btn-edit">
                    ✏️ Edit
                  </a>
