...
<div class="tenant-aips-page">
  ...
  {:else}
    ...
    <div class="page-header">
      ...
      <a href="/tenants/{data.tenantId}/preservations/create" class="btn-create">+ Create Preservation</a>
    </div>
    ...
    {:else if aips.length === 0}
      <div class="empty-state">
        ...
        <a href="/tenants/{data.tenantId}/preservations/create" class="btn-primary-link">Create Preservation</a>
      </div>
    {:else}
